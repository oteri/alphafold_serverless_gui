...
init:
	...
	docker  run --rm --user "$(shell id -u):$(shell id -g)"  -v ./components:/app -w /app -i -t  node:16  bash -c "mkdir frontend && cd frontend && npx create-react-app . frontend  --template typescript"
